...
<head>
    ...
    <title>Data Detail Peserta - Aveecena </title>
    <!-- General CSS Files -->
...
<body>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Detail Peserta | <?= $detail->nama ?> </h2>
                                <hr>
                                <p class="card-text"> berikut adalah data dari peserta yang dipilih mohon untuk menggunakan data dengan bijak dan tidak menyalah gunakan nya
                                </p>
                        ...
                        <div class="col-md-12 bg-white p-3" id="detail" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <h1 class="font-weight-bold card-title text-center" style="color: black;">Detail Peserta </h1>
                            ...
                            <table style="width: 100%" class="container text-center">
                                <tbody>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Nama Peserta :</span></td>
                                        <td> <?= $detail->nama ?></td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Profesi :</span></td>
                                        <td> <?= $detail->profesi ?></td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold"> Kelas Keperawatan</span></td>
                                        <td><?php 
                                                if ($detail->keperawatan == 1){ ?>
                                                <span class="badge badge-primary">Dibeli</span>
                                                <?php
                                                }else{
                                                ?>
                                                <span class="badge badge-danger">Belum Dibeli</span>
                                                <?php } ?>
                                        </td>
                                    </tr>
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold"> Kelas Kedokteran</span></td>
                                        <td><?php 
                                                if ($detail->kedokteran == 1){ ?>
                                                <span class="badge badge-primary">Dibeli</span>
                                                <?php
                                                }else{
                                                ?>
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold"> Kelas Gizi</span></td>
                                        <td><?php 
                                                if ($detail->gizi == 1){ ?>
                                                <span class="badge badge-primary">Dibeli</span>
                                                <?php
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold"> Kelas Apoteker</span></td>
                                        <td><?php 
                                                if ($detail->apoteker == 1){ ?>
                                                <span class="badge badge-primary">Dibeli</span>
                                                <?php
                                                }else{
                                                ?>
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold"> Kelas Kebidanan</span></td>
                                        <td><?php 
                                                if ($detail->kebidanan == 1){ ?>
                                                <span class="badge badge-primary">Dibeli</span>
                                                <?php
                                                }else{
                                                ?>
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        ...
                                        <td><?= date('d/m/y' , $detail->date_created); ?></td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div> <a href="https://github.com/syauqi">Gustian</a>
        </div>
    </footer>
    <!-- End Footer -->
