...
<head>
    ...
    <title>Update Data Peserta - Aveecena</title>
    <!-- General CSS Files -->
...
<body>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update data Peserta</h2>
                                <hr>
                                <p class="card-text">Admin bisa melakukan penggantian data pada peserta yang dipilih
                                </p>
                        ...
                        <?php foreach ($user as $u) { ?>
                            ...
                            <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="notlp" class="font-weight-bold" style="font-size: 20px;">No telpon</label>
                                    <input type="text" class="form-control" id="notlp" aria-describedby="notlp" required name="no_tlp" value="<?= $u->no_tlp ?>">
                                    <label for="profesi" class="font-weight-bold" style="font-size: 20px;">Profesi</label>
                                    <input type="text" class="form-control" id="profesi" aria-describedby="profesi" required name="profesi" value="<?= $u->profesi ?>">
                                    <input type="hidden" name="password" value="<?= $u->password ?>">
                                    <label for="pengaktifan" class="font-weight-bold" style="font-size: 20px;">Akun Aktif (0) untuk tidak aktif dan (1) untuk aktif</label>
                                    <input type="text" class="form-control" id="pengaktifan" aria-describedby="Active" required name="is_active" value="<?= $u->is_active ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" value="<?= $u->email ?>" id="exampleInputPassword1">
                                </div>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div><a href="https://github.com/usermean">Gustian adam</a>
        </div>
    </footer>
    <!-- End Footer -->
