...
<head>
    ...
    <title>Data Materi - Aveecena</title>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi Aveecena</h2>
                            <hr>
                            <p class="card-text"> Berikut adalah data materi yang bahan ajar di kelas aveecena</p>
