...
<head>
    <meta charset="utf-8" />
    <title>Aveecena - Tambah Materi</title>
...
?>
                        ...
                        <div class="row">
                            <div class="col-md-12 bg-white p-4 container"
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    ...
                                    <!--</div>-->
                                    <div class="form-group">
                                        <label for="yt">Masukan link youtube setelah watch?v=<B>contoh "UTmM4FeYCUE"</b></label>
                                            <input id="yt" type="text" class="form-control" name="yt">
                                                <?= form_error('nama', '<small class="text-danger">', '</small>'); ?>
                                            <div class="invalid-feedback">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                <label for="link">Masukan link Drive untuk Materi</label>
                                                    <input id="link" type="text" class="form-control" name="link">
                                                    <small>Contoh: https://drive.google.com/......</small>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                                ...
                                                $data['user'] = $this->db->get_where('guru', ['email' =>
                                                $this->session->userdata('email')])->row_array();
                                                echo $data['user']['nama_mapel'];?>" id="inputState" type="text" class="form-control" name="inputState">
                                    </div>
                                    <!--<div class="form-group">-->
                                    <!--    <label for="inputState">Kelas</label>-->
                                    <!--      <select required id="inputState" name="kelas" class="form-control">-->
                                    <!--            <option selected>Pilih disini</option>-->
                                    <!--            <option value="X">Keperawatan</option>-->
                                    <!--            <option value="X">Kebidanan</option>-->
                                    <!--            <option value="X">Kedokteran</option>-->
                                    <!--            <option value="X">Gizi</option>-->
                                    <!--            <option value="X">Keperawatan</option>-->
                                    <!--    </select>-->
                                    <!--</div>-->
                ...
                <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                    <div class="kt-footer__copyright">
                        2019&nbsp;&copy;&nbsp;<a href="instagram.com/gustin.adam" target="_blank"
                            class="kt-link">Gustian adam DKK</a>
                    </div>
                    <div class="kt-footer__menu">
                        Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by Gustian
                    </div>
                </div>
