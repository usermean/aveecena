...
<head><meta charset="ibm866">
    ...
    <title>Admin Dashboard - Aveecena</title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Sudah siap untuk menambahkan materi? siapkan materi dalam bentuk video yang sudah di upload di Youtube lalu salin tautan khusus setelah <b>watch?v=</b> https://www.youtube.com/watch?v=<b>KpyYdoKN61g</b> untuk kemudian di tempel</p>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Hope you happy today, sebagai admin kamu punya akses penuh untuk mengendalikan jalan nya proses e-learning dalam website ini baik mengatur pengajar seperti menambah, menghapus dan merubah, begitupun dengan data peserta elearning yang ada dalam kelas aveecena</p>
                                <div class="mt-4">
