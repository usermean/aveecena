                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown" id="navpelajaran">
                                <a href="<?= base_url('welcome/kelas') ?>" class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">Kelas</a>
                            </li>
                            <li class="nav-item submenu dropdown" id="navlive">
                                <a href="<?= base_url('welcome/live') ?>" class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">Live</a>
                            </li>
