...
<head>
    ...
    <title>Data Admin - Aveecena</title>
    <!-- General CSS Files -->
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Admin Aveecena</h2>
                            <hr>
                            <p class="card-text"> Ini adalah semua admin ang ada di Kelas Aveecena. </p>
                            <a href="<?= base_url('admin/add_admin') ?>" class="btn btn-success">Tambah
                                Data Admin ⭢</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                <div class="table-responsive">
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_admin/' . $u->id); ?>" class="btn btn-info">Update ⭢</a>

                                                        <a href="<?php echo site_url('admin/delete_admin/' . $u->id); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                    </td>
                                    ...
                                    <p class="small font-weight-bold">Pendaftaran Admin bisa dilakukan oleh Admin yang sudah terdaftar</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div><a href="https://github.com/syauqi">Gustian Adam</a>
        </div>
    </footer>
    <!-- End Footer -->
