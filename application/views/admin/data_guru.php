...
<head>
    ...
    <title>Data Pengajar - Aveecena</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Pengajar Aveecena</h2>
                            <hr>
                            <p class="card-text"> Untuk menambahkan pengajar baru siahkan klik tombol dibawah ini</p>
                        ...
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                <div class="table-responsive">
                                    ...
                                    <p class="small font-weight-bold">Pendaftaran pengajar hanya dapat dilakukan admin dan tidak bisa dilakukan sendiri</p>
                                </div>
                            </div>
                        </div>
                    </div>
