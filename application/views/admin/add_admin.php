...
<head>
    ...
    <title>Tambah Data Admin - Aveecena</title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Perlu diingat untuk memasukan data Admin dengan benar agar tidak terjadi kesalahan dikemudian hari
                                </p>
