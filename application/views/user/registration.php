...
<head>
    ...
    <title>Aveecena - Healtcare learning center</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    <h2>Pendaftaran Aveecena</h2>
                    <div class="page_link">
                        <a href="<?= base_url('welcome') ?>">Beranda</a>
                        <a href="<?= base_url('auth/registration') ?>">Pendaftaran</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5 mb-5" id="registration">
        <div class="row bg-registration p-3">
            ...
            <div class="col-md-6 mx-auto my-auto mt--5">
                <form action="<?= base_url('auth/registration_act') ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="profesi" class="label-font-register">Profesi</label>
                        <input type="text" autocomplete="off" class="form-control effect-9" name="profesi" id="profesi" value="<?= set_value('profesi'); ?>">
