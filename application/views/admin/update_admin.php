...
<head>
    ...
    <title>Update Data Admin - Aveecena</title>
    <!-- General CSS Files -->
...
<body>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Update data Admin meliputi Email dan Nama Lengkap.
                                    Kita tidak bisa mengubah password Admin, Hanya Admin tersebut yang dapat mengubah passwordnya
                                    sendiri.
                                </p>
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('admin/admin_edit') ?>">
                                    ...
                                    <div class="form-group" id="detail">
                                        ...
                                        <input id="nama" type="text" value="<?= $u->username ?>" class="form-control" name="nama">
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div> <a href="https://github.com/usermean">Gustian</a>
        </div>
    </footer>
    <!-- End Footer -->
