...
<head>
    ...
    <title>Tambah Data Pengajar - Aveecena</title>
    <!-- General CSS Files -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/add_guru') ?>">Tambah Admin</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Perlu diingat untuk memasukan data pengajar dengan benar agar tidak terjadi kesalahan dikemudian hari, pilih mata pelajaran dengan benar agar pengajar bisa dengan benar mengajarkan sesuai kapasitas
                                </p>
