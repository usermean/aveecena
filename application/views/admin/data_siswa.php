        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Peserta Aveecena</h2>
                            <hr>
                            <p class="card-text"> Berikut adalah data peserta kelas aveecena mohon gunakan data tersebut dengan bijak dan tidak disalah gunakan </p>
                            <a href="<?= base_url('auth/registration') ?>" class="btn btn-success">Tambah
                                Data Peserta ⭢ </a>
                        </div>
                    </div>
                    <div class="row">
