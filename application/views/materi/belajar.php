    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mx-auto mt-4">
                <a href="<?= $detail->link; ?>">
                    <button class="btn btn-primary mr mr-3" style="position: absolute; right: 0;" target="_blank">Download Materi</button>
                </a>
                <br>
                 <video class="afterglow mt mt-4" autoplay id="myvideo" width="1280" height="720" data-youtube-id="<?= $detail->yt; ?>" modestbranding=1>
                </video>
            </div>
        </div>
    </div>
