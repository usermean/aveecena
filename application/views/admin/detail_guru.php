...
<head>
    ...
    <title>Data Detail Pengajar - Aveecena </title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Detail pengajar | <?= $detail->nama_guru ?> </h2>
                            <hr>
                            <p class="card-text">Berikut adalah detail dari pengajar yang dipilih mohon gunakan data dengan bijak dan tidak disalah gunakan.
                            </p>
