...
<head>
    ...
    <title>Tambah Data Materi - Aveecena </title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Pastikan untuk memasukan data dengan benar agar tidak ada error pada saat digunakan para peserta
                                </p>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="kelas">Kelas</label>
                                                    <input readonly id="kelas" type="text" class="form-control" name="kelas">
                                                    <small>Contoh: https://drive.google.com/......</small>
                                            </div>
                                            <!--<div class="form-group">-->
