...
class Welcome extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('email')) {
            $data = [
                'keperawatan' => $this->db->get_where('siswa',['keperawatan' => 1])->num_rows(),
                'kebidanan' => $this->db->get_where('siswa',['kebidanan' => 1])->num_rows(),
                'kedokteran' => $this->db->get_where('siswa',['kedokteran' => 1])->num_rows(),
                'gizi' => $this->db->get_where('siswa',['gizi' => 1])->num_rows(),
                'apoteker' => $this->db->get_where('siswa',['apoteker' => 1])->num_rows(),
            ];
